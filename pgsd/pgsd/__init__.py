...
"""The PGSD main module.

The main package :py:mod:`pgsd` is the root package. It holds the submodules
:py:mod:`pgsd.fl` and :py:mod:`pgsd.hoomd`, but does not import them by default.
